...
"en": {
 ...
 "s3":"Indoor and outdoor are two different products",
 "in":"Indoor","out":"Outdoor",
 "rows":[("Pixel pitch","P1.5 – P3 (fine pitch)","P4 – P10 and up"),
         ("Brightness","600 – 1,500 nits","5,000 – 10,000+ nits"),
         ("Viewing distance","A few feet to ~30 ft","30 ft and beyond"),
         ("Protection","Standard cabinet","Sealed, IP-rated for sun and rain")],
 "tip":"Rule of thumb: pixel pitch in millimetres × 10 = the minimum comfortable viewing distance in feet. Tell us where the closest viewer sits and we pick the pitch.",
...
"pt": {
 ...
 "s3":"Interno e externo são dois produtos diferentes",
 "in":"Interno","out":"Externo",
 "rows":[("Pixel pitch","P1.5 – P3 (fine pitch)","P4 – P10 ou maior"),
         ("Brilho","600 – 1.500 nits","5.000 – 10.000+ nits"),
         ("Distância de visão","De poucos metros a ~9 m","De 9 m para cima"),
         ("Proteção","Gabinete comum","Selado, índice IP para sol e chuva")],
 "tip":"Regra prática: pixel pitch em milímetros × 10 = a distância mínima confortável de visualização, em pés. Diga onde senta quem está mais perto que escolhemos o pitch.",
